...
const RPClient = require('reportportal-client'),
     ...
     * @type {String}
     */
    DEFAULT_LAUNCH_NAME = 'Newman launch',
     ...
     * @type {String}
     */
    DEFAULT_REQUEST_STEP_NAME = 'Postman request';
...
module.exports = function (emitter, options, collectionRunOptions) {
    ...
    emitter.on('beforeRequest', (err, o) => {
        ...
        const testObj = collectionMap.get(o.cursor.ref),
            ...
            stepName = o.request.description ? o.request.description.content : DEFAULT_REQUEST_STEP_NAME,
            // Creates a new step
    ...
    function getTags (variables) {
        ...
        var attributes = [];
		variables.split(',').forEach((keyPair) => {
            if (keyPair.includes(":")) {
                attributes.push({"key": keyPair.split(":")[0], "value": keyPair.split(":")[1]});
            } else {
                attributes.push({"value": keyPair});
            }
        });
